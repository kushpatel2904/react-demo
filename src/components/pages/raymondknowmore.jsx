...
export default function CustomTailoring({ onBack }) {
  ...
  useEffect(() => {
    ...
    const fetchImages = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, "raymondknowmore"));
        const imgData = {};
    ...
    <div className="custom-tailoring-wrapper">
      ...
      <section className="ct-process-section">
        <div className="process-step">
          {image.ct_step1 ? (
             <img src={image.ct_step1} alt="Step 1" className="step-image" />
          ) : (
        ...
        <div className="process-step">
          {image.ct_step2 ? (
             <img src={image.ct_step2} alt="Step 2" className="step-image" />
          ) : (
             <div className="step-image-placeholder"></div>
          )}
        ...
        <div className="process-step">
          {image.ct_step3 ? (
             <img src={image.ct_step3} alt="Step 3" className="step-image" />
          ) : (
             <div className="step-image-placeholder"></div>
          )}
        ...
        <div className="process-step">
          {image.ct_step4 ? (
             <img src={image.ct_step4} alt="Step 4" className="step-image" />
          ) : (
             <div className="step-image-placeholder"></div>
          )}
...
<section className="ct-showcase">
  ...
  <div className="showcase-image">
    {image.ct_image1 ? (
      <img src={image.ct_image1} alt="section1" />
    ) : (
...
<section className="ct-showcase reverse">
  ...
  <div className="showcase-image">
    {image.ct_image2 ? (
      <img src={image.ct_image2} alt="section2" />
    ) : (
...
<section className="ct-showcase">
  ...
  <div className="showcase-image">
    {image.ct_image3 ? (
      <img src={image.ct_image3} alt="section3" />
    ) : (
